...
function LandingContent() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setShowScrollTop(scrollPosition > scrollHeight * 0.5);
    };
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {isLoading && (
          <motion.div
            className="fixed inset-0 z-[100] bg-ktv-bg-dark flex flex-col items-center justify-center"
            exit={{ opacity: 0 }}
          ...
          >
            ...
            <div className="w-32 h-1 bg-ktv-surface rounded-full overflow-hidden">
              <motion.div
                className="h-full bg-ktv-red rounded-full"
                initial={{ width: '0%' }}
                animate={{ width: '100%' }}
      ...
      >
        {/* ========== SCROLL PROGRESS BAR ========== */}
        <motion.div
          className="fixed top-0 left-0 right-0 z-50 h-[3px] bg-ktv-red origin-left"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-14 sm:h-16">
              ...
              <div className="flex items-center gap-2">
                {/* Theme & Language toggles - visible on desktop, hidden on mobile */}
                <motion.div
          ...
          <AnimatePresence>
            {mobileMenuOpen && (
              <motion.div
                ...
                className="md:hidden overflow-hidden bg-ktv-bg-dark/95 backdrop-blur-xl border-b border-ktv-border-faint"
              >
        ...
        <AnimatePresence>
          {showScrollTop && (
            <motion.button
              ...
              onClick={scrollToTop}
              className={`fixed bottom-24 ${isRTL ? 'left-6' : 'right-6'} z-30 w-11 h-11 rounded-full bg-ktv-surface border border-ktv-border hover:bg-ktv-surface-hover hover:border-ktv-red/30 flex items-center justify-center transition-colors shadow-lg`}
